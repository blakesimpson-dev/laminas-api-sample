...
final class Version20260924104628 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE item_filter (id UUID NOT NULL, filter_name VARCHAR(255) NOT NULL, realm VARCHAR(255) NOT NULL, filter TEXT DEFAULT NULL, description VARCHAR(255) NOT NULL, version VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, public BOOLEAN NOT NULL, PRIMARY KEY (id))');
    }
